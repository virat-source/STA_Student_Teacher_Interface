<?php
	...
	$sql = "SELECT CONCAT(FIRSTNAME , ' ' , MIDDLENAME , ' ' , LASTNAME, ' ', STUDENT_ID ) AS Name FROM `student_info`"; 
				...
				<div class="modal-body">
					...
					<div class="col-md-8">
						...
						<div class="form-group">
							...
							<input id= "MIDDLENAME" type="text"  class="form-control" name="MIDDLENAME" autocomplete="off" required="required">							
						</div>
