...
if (strcmp($script_tz, ini_get('date.timezone'))){
	...
	if(ISSET($_POST['save'])){
		...
		mysqli_query($conn, "INSERT INTO `student_grades` VALUES('', '$sch', '$name', '$instructor', '$subject', '$tr_type', '$cat', '$grade','$hours','$finals','$dt1')") or die(mysqli_error());
		header("location: index.php?id=$sch?cat=$cat");
