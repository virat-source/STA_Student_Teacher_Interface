<?php
	...
	$sqlsid = "SELECT * FROM `subjects` WHERE type = 'Inspection'";
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `student_grades` WHERE schedule='$id' and cat='$cat'") or die(mysqli_error());
	...
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="col-md-8">
						...
						<div class="form-group">
							...
							<input id="cat" type="hidden" class="form-control" name="cat" value="<?php echo $cat ?>">
							<br></br>
			...
			?>
							...
							<select id="training_type" name="training_type" autocomplete="off" required="required" value="Behind the Wheel - Range">
						...
						<div class="form-group">
							<label>Grade</label>
							<input type="text" class="form-control" name="grade" value="Refer to Evaluations for Grade"/>
						</div>
