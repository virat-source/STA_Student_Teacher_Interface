...
<body>
	<nav class="navbar navbar-default">
		...
		<a class="navbar-brand" href="../index.php?page=schedule">Calendar</a>
		</div>
	</nav>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `student_grades` WHERE schedule='$id' AND cat='Inspection'") or die(mysqli_error());
