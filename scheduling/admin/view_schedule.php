...
<div class="modal-footer display">
	<div class="row">
		<div class="col-md-12">
			...
			<br><a href="search_logs/index.php?id=<?php echo $id ?>">View Logged Skill Enteries</a></button></br>
			<br><a href="search_evals/index.php?id=<?php echo $id ?>">View Logged Eval Enteries</a></button></br>
