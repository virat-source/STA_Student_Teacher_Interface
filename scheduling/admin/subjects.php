			...
			<form action="" id="manage-subject">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Skill/Inspection</label>
								<select class="form-control" name="type" required="required">
								<option>Skill</option>
								<option>Inspection</option>
								<option>Drive Training</option>
								<option>Lab</option>
                           </select>
							</div>
							<div class="form-group">
								<label class="control-label">FMCSA Code</label>
								<textarea class="form-control" name="fmcsa_code" required="required"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Training Type</label>
								<select class="form-control" name="category" required="category">
								<option>Behind the Wheel - Range</option>
								<option>Behind the Wheel - Public Roads</option>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										...
										<p>Skill/Inspection: <small><b><?php echo $row['type'] ?></b></small></p>
										<p>FMCSA Code:<small><b><?php echo $row['fmcsa_code'] ?></b></small></p>
										<p>Training Type:<small><br><b><?php echo $row['category'] ?></b></small></p>
